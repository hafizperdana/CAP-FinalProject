...
url = f'https://opensky-network.org/api/flights/arrival?airport={airport}&begin={begin_timestamp}&end={end_timestamp}'
...
if response.status_code == 200:
    ...
    parquet_file_path = f'/home/pablo/final_project/data/flight_data_{end_date_string}.parquet'
